	...
	<body>
		...
		<div class="page-container">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<div class="l">
					<a href="javascript:;" onclick="del(getDTSelect(), '/role/del/', reloadTable)" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
					<a class="btn btn-primary radius" onclick="add('添加角色','system-role-add.jsp')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a>
				</div>
				<div class="r">
					<input type="text" id="search" placeholder="角色名称" style="width:250px" class="input-text">
		...
		<script type="text/javascript" src="../assets/pages/role_list.js"></script>
	</body>
