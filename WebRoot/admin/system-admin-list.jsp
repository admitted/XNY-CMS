...
<html>
	...
	<body>
		...
		<div class="page-container">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<div class="l">
					...
					<a href="javascript:;" onclick="add('添加管理员','system-admin-add.jsp')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a>
				</div>
				<div class="r">
					日期范围：
		...
		<script type="text/javascript" src="../assets/pages/admin_list.js"></script>
	</body>
