...
<html>
	...
	<body>
		...
		<div class="page-container">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<div class="l">
					...
					<a class="btn btn-primary radius" onclick="add('添加栏目','folder-add.jsp')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a>
				</div>
				<div class="r">
					<input type="text" id="search" placeholder="栏目名称" style="width:250px" class="input-text">
		...
		<script type="text/javascript" src="../assets/pages/folder-list.js"></script>
	</body>
